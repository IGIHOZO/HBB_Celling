"""
Django settings for exml_converter_project project.
...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-t05j$feq7gf55u@=zn#qws#t3q04(jo4qcmg0f0h^4!vyoo3u3',
)
...
ROOT_URLCONF = 'exml_converter_project.urls'
...
WSGI_APPLICATION = 'exml_converter_project.wsgi.application'
...
if database_url:
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('DB_NAME', 'HBB'),
            'USER': os.getenv('DB_USER', 'hbb'),
